...
// Stat Item — plain div, no animation library
...
// Solution Card — CSS-only hover, no framer
const SolutionCard = ({ title, status, image }: { title: string; status: string; image: string }) => (
  <div className="group relative cursor-pointer fade-up">
    <div className="relative h-[280px] sm:h-[380px] lg:h-[450px] w-full rounded-2xl overflow-hidden shadow-2xl">
...
export default function Home() {
  return (
    <main className="bg-white min-h-screen overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-28 lg:pt-28 pb-0 bg-[#f0f9ff] overflow-hidden">
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-black text-slate-900 tracking-tighter leading-[0.9] mb-12 fade-up">
            ...
            <div className="flex justify-center fade-up fade-up-delay-1">
              <Link
                href="/signup"
                className="bg-primary hover:bg-slate-900 text-white px-10 py-5 rounded-full font-bold text-sm shadow-xl inline-flex items-center gap-3"
              >
          ...
          {/* Hero Ship Image */}
          <div className="relative w-full max-w-6xl mx-auto rounded-t-[40px] overflow-hidden shadow-[0_-20px_60px_-20px_rgba(37,99,235,0.15)] fade-up fade-up-delay-2">
            <div className="aspect-[21/9] relative">
              <Image
                src="/hero_ship.png"
                alt="Vortex Global Logistics Fleet"
                fill
            ...
            <div className="absolute top-1/2 left-12 -translate-y-1/2 hidden md:block">
              <button className="w-20 h-20 rounded-2xl bg-white/20 border border-white/30 flex items-center justify-center text-white shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start mb-24">
            <div className="lg:col-span-1">
              ...
              <p className="text-slate-500 font-bold text-sm uppercase tracking-tight leading-relaxed mb-10 max-w-md">
                Our comprehensive logistics services are designed to handle every stage of your supply chain with precision.
              </p>
              <Link
                href="/services"
                className="bg-slate-900 hover:bg-primary text-white px-8 py-4 rounded-sm font-black text-[10px] uppercase tracking-[0.3em] inline-block"
              >
                Explore Services ›
              </Link>
            </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
              <SolutionCard title="Freight Forwarding" status="Shipment Tracking" image="/freight_card.png" />
              <SolutionCard title="Continental Ocean Freight" status="International" image="/ocean_card.png" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              <div key={i} className="text-center">
                <div className="w-20 h-20 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-primary mx-auto mb-8 shadow-sm">
                  <step.icon size={32} />
                </div>
      ...
      <section className="py-32 bg-slate-50">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative h-[350px] sm:h-[500px] lg:h-[600px] rounded-[40px] overflow-hidden shadow-xl">
              <Image
      ...
      <section className="py-32 bg-slate-900 relative overflow-hidden">
        {/* Decorative blob — hidden on mobile via CSS in globals.css */}
        <div className="absolute top-0 right-0 w-1/2 h-full bg-primary/10 blur-[150px] -translate-y-1/2 translate-x-1/3 pointer-events-none" aria-hidden="true" />
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-white/5 p-12 rounded-[40px] border border-white/10 flex flex-col justify-between"
              >
                <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-14 h-14 rounded-full overflow-hidden grayscale flex-shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-6">
                <Link
                  href="/signup"
                  className="bg-primary hover:bg-slate-900 text-white px-10 py-5 rounded-full font-bold text-sm shadow-xl inline-block"
                >
                  Get Started
                </Link>
                <Link
                  href="/contact"
                  className="bg-white hover:bg-slate-50 text-slate-900 border border-slate-200 px-10 py-5 rounded-full font-bold text-sm shadow-sm inline-block"
                >
                  Book A Demo
                </Link>
              </div>
            ...
            <div className="relative h-[400px]">
              <div className="absolute top-0 right-0 w-64 h-64 rounded-2xl overflow-hidden shadow-2xl rotate-3 z-10">
                <Image src="/ocean_card.png" alt="Ocean Freight" fill className="object-cover" loading="lazy" />
              </div>
              <div className="absolute bottom-0 left-0 w-80 h-80 rounded-2xl overflow-hidden shadow-2xl -rotate-6">
                <Image src="/freight_card.png" alt="Freight Forwarding" fill className="object-cover" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
