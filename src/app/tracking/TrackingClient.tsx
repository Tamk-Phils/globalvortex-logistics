...
import { ShieldCheck, MapPin, Activity, Globe } from "lucide-react";
            ...
            <section className="pt-48 pb-64 bg-[#f0f9ff] relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full opacity-[0.05] pointer-events-none grayscale">
                    <Image 
                        ...
                        alt="Global Logistics Network Grid Overlay" 
                        fill 
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={stat.title} className="flex items-center gap-6 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm">
                ...
                <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                            ...
                            <div key={item.title} className="p-12 bg-slate-900 rounded-[40px] text-white">
