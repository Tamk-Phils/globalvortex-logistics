            ...
            <AnimatePresence>
                {error && (
                    ...
                    >
                        ...
                        <div>
                            <p className="font-black text-red-500 text-[10px] uppercase tracking-widest">TRACKING ERROR</p>
                            ...
                            <div className="mb-20 relative px-4">
                                <div className="flex flex-col md:flex-row items-center gap-12 justify-between relative z-10">
                                    <div className="text-center md:text-left space-y-2">
                                       <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest">ORIGIN</p>
